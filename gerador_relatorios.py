...
class GeradorRelatoriosOtimizado:
   ...
   def criar_filtros_para_curso(self, curso_config, periodo, forma_ingresso):
    """
    Cria dicionário de filtros exatamente no formato esperado
    pelo relatório 'Listagem de Alunos' do SIGA
    """

    # período vem como '20251' ou '20252'
    ano = periodo[:4]
    semestre = periodo[4]
    ...
    filtros = {
        ...
        'idnivelcurso': curso_config['nivel'],  # 🔴 ESSENCIAL
        'idturno': '',
        'idstatusaluno': '',
        'idsituacaoaluno': '',
        'idformaingresso': forma_ingresso,      # 125 ou 124
        'idacaoafirmativa': '',
        'anosem_ingresso': f'{ano}/{semestre}', # 🔴 FORMATO CORRETO
...
def obter_cursos_predefinidos(self, cursos_selecionados=None):
    """Retorna configuração dos cursos predefinidos (compatível com SIGA)"""
